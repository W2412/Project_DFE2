...
os.chdir('D:\\MAWIN') # directory where input files are, use double '\'
MacroInpName = 'MACRO_3_LAYER.inp' # Name of macroscale input file
RVEInpName = 'RVE_VF_20_DIR_1_LAYERED.inp' # Name of RVE input file 
NewInpName = 'DFE2_2D_ACT_4.inp' # Name of new Direct FE2 input file
...
SF = []
for i in range(Nele):
    if ((201<=(i)<=399) and (((i)-201)%2)) or ((402<=(i)<=598) and (((i)-402)%2)) or ((802<=(i)<=998) and (((i)-802)%2)):
        print(i)
        pass
    else: 
